...
This is a sample template for CisContols - Below is a brief explanation of what we have generated for you:
...
aws cloudformation describe-stacks \
    --stack-name ciscontols --query 'Stacks[].Outputs'
```
